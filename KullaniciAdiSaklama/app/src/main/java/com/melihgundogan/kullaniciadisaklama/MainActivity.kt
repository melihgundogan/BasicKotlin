package com.melihgundogan.kullaniciadisaklama
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var sharedPreferences : SharedPreferences  //lateinit ben sonra tanımlayacağım demek
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = this.getSharedPreferences("com.melihgundogan.kullaniciadisaklama", Context.MODE_PRIVATE)
